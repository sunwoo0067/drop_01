...
class AIProvider(ABC):
    ...
    def analyze_visual_layout(self, image_data: bytes, prompt: str = "Analyze visual layout.", model: Optional[str] = None) -> str:
        """
        Analyzes the visual layout and spatial information of an image.
        Default implementation falls back to describe_image.
        """
        return self.describe_image(image_data, prompt=prompt, model=model)
