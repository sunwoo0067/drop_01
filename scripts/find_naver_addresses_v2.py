...
def test():
    with session_factory() as session:
        ...
        # Try finding address book
        r = requests.get("https://api.commerce.naver.com/external/v1/seller/address-book", headers=headers, params={"page": 1, "size": 10})
        print(f"Address Book Status: {r.status_code}")
